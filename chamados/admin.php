...
.login-logo-text{display:block;line-height:1.2;text-align:left}
.login-logo-sub{display:block;font-size:.75rem;color:var(--muted);letter-spacing:.04em}
.login-logo-badge{display:inline-block;font-size:.6rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;background:var(--accent);color:#fff;padding:2px 8px;border-radius:20px;margin-top:4px}
...
/* manter compatibilidade com form-group usado dentro do painel */
...
.sidebar-logo .adm-tag{display:inline-block;background:rgba(26,107,66,.1);color:var(--accent);border-radius:20px;padding:2px 10px;font-size:10px;font-weight:700;margin-top:6px;letter-spacing:.06em;border:1px solid rgba(26,107,66,.2)}
.sidebar-nav{flex:1;padding:12px 0}
.nav-section{padding:10px 20px 4px;font-size:10px;font-weight:700;color:var(--muted);opacity:.6;text-transform:uppercase;letter-spacing:.8px}
.nav-item{display:flex;align-items:center;gap:10px;padding:10px 20px;color:var(--muted);font-size:14px;font-weight:500;transition:background .15s,color .15s;text-decoration:none;border-left:3px solid transparent}
  ...
  <div class="login-card">
    ...
    <form method="post" autocomplete="on">
      ...
      <div class="field">
        ...
        <input type="password" id="pw" name="password" placeholder="••••••••••••" required autofocus autocomplete="current-password">
      </div>
    ...
    <p style="text-align:center;margin-top:20px;font-size:12px;color:var(--muted)">
      <a href="index.php" style="color:var(--accent)">← Portal do Cliente</a>
    </p>
  </div>
</div>
